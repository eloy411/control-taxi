...
function Denuncias() {
    ...
    return (
        <div>
            <h1>Denuncias</h1>
            <div className="contenedor-denuncias-top">
                <div className="contenedor-denuncias-top-select">
                    <div>
                        ...
                        <button className="button-30" htmlFor='search' onClick={() => buscarSpecificDenuncias(search)}>: Buscar</button>
                    </div>
                    <div>
                        <label htmlFor=''>Lista : </label>
                        <button className="button-30" onClick={(event) => { handleChoose('licencias', event.target) }}>Licencias</button>
                        <button className="button-30" onClick={(event) => { handleChoose('matriculas', event.target) }}>Matrículas</button>
                    </div>
                </div>
            ...
            <div className="contenedor-denuncias">
                ...
                <div className="container-denuncias-options">


                    <div>
                        <h3 className="margin-denuncias">Selecciona identificación </h3>
                        <select className="margin-denuncias" onChange={(event) => specificLicencia(event.target.value)}>
                    ...
                    <div>
                        <div className="margin-denuncias">
